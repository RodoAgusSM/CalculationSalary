 ...
 * @author Sony
 */
public class ImpresionCRI extends javax.swing.JFrame {
    ...
    public ImpresionCRI(Sistema modelo) {
        initComponents();
        miModelo = modelo;
        cargarTablaCRD();
        jTblImpresionCRI.setEnabled(false);
    }

    public void mostrarTablaCRI() {
    ...
    private void initComponents() {
        ...
        jTblImpresionCRI = new javax.swing.JTable();
        ...
        jTblImpresionCRI.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null}
            },
            new String [] {
        ...
        jScrollPane1.setViewportView(jTblImpresionCRI);
    ...
    private javax.swing.JTable jTblImpresionCRI;
    // End of variables declaration//GEN-END:variables

    private void cargarTablaCRD() {
        String data[][] = {};
        String[] columnNames = {"Sueldo", "IRPF", "IVA recibos", "Pago IVA"};
        tabla = new DefaultTableModel(data, columnNames);
        jTblImpresionCRI.setModel(tabla);
    }
}
