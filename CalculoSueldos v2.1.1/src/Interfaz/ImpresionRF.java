 ...
 * @author Sony
 */
public class ImpresionRF extends javax.swing.JFrame implements Printable {

    private DefaultTableModel tabla;
    int cont = 0;
    private Sistema miModelo;

    public ImpresionRF(Sistema modelo) {
        initComponents();
        miModelo = modelo;
        cargarMenusDesplegables();
        cargarTablaRF();
        jTblImpresionRF.setEnabled(false);
    }

    public void mostrarTablaRF(ReciboFicto unRF) {
        tabla.insertRow(cont, new Object[]{});
        tabla.setValueAt(unRF.getNombre().toUpperCase(), cont, 0);
        tabla.setValueAt(unRF.getSueldo(), cont, 1);
        tabla.setValueAt(unRF.getIRPF(), cont, 2);
        cont++;
    }
    ...
    private void initComponents() {
        ...
        jTblImpresionRF = new javax.swing.JTable();
        ...
        jTblImpresionRF.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null}
            },
            new String [] {
        ...
        jScrollPane1.setViewportView(jTblImpresionRF);
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
       ...
       Logger.getLogger(ImpresionRF.class.getName()).log(Level.SEVERE, null, ex);
    }
    ...
    private javax.swing.JTable jTblImpresionRF;
    // End of variables declaration//GEN-END:variables

    private void cargarTablaRF() {
        String data[][] = {};
        String[] columnNames = {"Nombre", "Sueldo", "IRPF"};
        tabla = new DefaultTableModel(data, columnNames);
        jTblImpresionRF.setModel(tabla);
    }
